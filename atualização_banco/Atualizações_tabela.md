...
Executar caso as tabelas brutas não tenham sido carregadas na rotina.
...
### CLIENTE 0042 / 0889 / 0910 / 1749

 TODAS AS TABELAS (FULL).

### CLIENTE 0103 — CUSTO E FATURAMENTO **NÃO PRECISA DE TODAS AS TABELAS**

 Executar blocos: CUSTO, FINANCEIRO, FATURAMENTO.

### CLIENTE 0682

 Executar blocos: ATENDIMENTO, AGENDA, CUSTO, FINANCEIRO, FATURAMENTO, SUPRIMENTOS, CUSTOMIZADOS, PEP.

### CLIENTE 1651 — ATENDIMENTO E FATURAMENTO

 Executar blocos: ATENDIMENTO, FATURAMENTO.

### CLIENTE 1990 — ATENDIMENTO, CUSTO E FATURAMENTO

 Executar blocos: ATENDIMENTO, CUSTO, FATURAMENTO.
